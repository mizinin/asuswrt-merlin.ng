...
export DSL-AX82U += DISABLE_PROXYSTA_UI=y WIREGUARD=y SNMPD=y IPV6S46=y
...
export RT-AX95Q += UPNPIGD2=n VISUALIZATION=n WIREGUARD=y SNMPD=y
...
export RT-AXE95Q += UPNPIGD2=n VISUALIZATION=n WIREGUARD=y SNMPD=y VPN_FUSION=n
...
export RT-AX82_XD6 += BUILD_NAME="RT-AX82_XD6" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y IPV6SUPP=y \
        ...
        CAPTCHA=y ASD=y AHS=y INTERNETCTRL=y GAME_MODE=n MSSID_PRELINK=y PC_SCHED_V3=y INSTANT_GUARD=y ACL96=y IPV6S46=y GOOGLE_ASST=y ASUSCTRL=y WIREGUARD=y COMFW=y MSSID_REALMAC=y
export RT-AX82_XD6 += DNSPRIVACY=y FORCE_AUTO_UPGRADE=n
export RT-AX82_XD6 += IFTTT=y NTPD=y OPENSSL11=y NANO=y UPNPIGD2=n
export RT-AX82_XD6 += TOR=y SNMPD=y NFS=y WIREGUARD=y
...
export RT-AX5400 += BUILD_NAME="RT-AX5400" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=n LACP=y DHD_6715B0=y WTFAST=n REPEATER=y \
		...
		GAME_MODE=n INSTANT_GUARD=y ACL96=y GOOGLE_ASST=y COMFW=y WIREGUARD=y AMAS_ETHDETECT=y IPV6S46=y OCNVC=y
...
export RT-AX5400 += UPNPIGD2=n VISUALIZATION=n WIREGUARD=y SNMPD=y VPN_FUSION=n
...
export TUF-AX5400 += UPNPIGD2=n VISUALIZATION=n WIREGUARD=y TUF_UI=n SNMPD=y
...
export TUF-AX3000 += UPNPIGD2=n VISUALIZATION=n IFTT=y LACP=n TUF_UI=n VPN_FUSION=n FRS_LIVE_UPDATE=n SNMPD=y
...
export GT-AX11000_PRO += BUILD_NAME="GT-AX11000_PRO" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y \
		...
		VISUALIZATION=n WIREGUARD=y USB_WAN_BACKUP=y OCNVC=y MAX_VPNF=4 WTFAST_V2=y \
		NFS=y SNMPD=y TOR=y UPNPIGD2=y NANO=y NTPD=y DNSPRIVACY=y IPSET=y
...
export RT-AX88U_PRO += BUILD_NAME="RT-AX88U_PRO" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
		...
		VISUALIZATION=n COMFW=y BTN_WPS_ALLLED=y WIREGUARD=y REVERTFW=y INTEL_EVO=y IG_SITE2SITE=n OCNVC=y WTFAST_V2=y \
...
export TUF-AX3000_V2 += UPNPIGD2=n VISUALIZATION=n IFTT=y LACP=n TUF_UI=n VPN_FUSION=n FRS_LIVE_UPDATE=n SNMPD=y
