...
export RT-AX88U += BUILD_NAME="RT-AX88U" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
		...
		HFS="tuxera" NEWSSID_REV2=y NEW_APP_ARM=y VISUALIZATION=n BONDING=y NETOOL=y TRACEROUTE=y INFO_EXAP=y WTFAST_V2=y \
...
export GT-AX11000 += BUILD_NAME="GT-AX11000" EXT_PHY="BCM84880" SWITCH2="" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
		...
		NTFS="tuxera" HFS="tuxera" NEWSSID_REV2=y NEW_APP_ARM=y VISUALIZATION=n BONDING=y BONDING_WAN=y NETOOL=y \
		...
		IPV6S46=y COMFW=y CALC_NVRAM=y DNSQUERY_INTERCEPT=n USB_WAN_BACKUP=y MAX_VPNF=4 \
		NFS=y SNMPD=n TOR=y UPNPIGD2=y NANO=y NTPD=y
...
export RT-AX58U += BUILD_NAME="RT-AX58U" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y SW_CTRL_ALLLED=y \
		...
		LINUX_MTD="64" DEBUGFS=y TEMPROOTFS=n SSH=y EMAIL=y FRS_FEEDBACK=n SYSSTATE=y ROG=n STAINFO=y CLOUDCHECK=n GEARUPPLUGIN=y \
		...
		VISUALIZATION=n BONDING=n BONDING_WAN=n NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=n ALEXA=y IFTTT=y SW_HW_AUTH=y \
		...
		ACL96=y GOOGLE_ASST=y COMFW=n WIREGUARD=y HND_ROUTER_AX_675X=y CABLEDIAG=y CALC_NVRAM=y USB_WAN_BACKUP=y \
		NFS=y SNMPD=n TOR=y UPNPIGD2=y NANO=y NTPD=y
...
export RT-AX56U += BUILD_NAME="RT-AX56U" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y SW_CTRL_ALLLED=y \
		...
		HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y NEW_APP_ARM=y VISUALIZATION=n BONDING=n BONDING_WAN=n NETOOL=y TRACEROUTE=y \
		...
		ACL96=y GOOGLE_ASST=y ASUSCTRL=y WIREGUARD=y HND_ROUTER_AX_675X=y CABLEDIAG=y CALC_NVRAM=y  COMFW=y \
		NFS=y SNMPD=n TOR=y UPNPIGD2=y NANO=y NTPD=y
...
export RT-AX86U := $(HND-962118_BASE) ETLAN_LED=y LAN4WAN_LED=y LED_BTN=y I2CTOOLS=y GEFORCENOW=y \
		UUPLUGIN=y TCPLUGIN=y GAME_MODE=y
...
export RT-AX86U += BUILD_NAME="RT-AX86U" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y HND_WL=y \
		...
		LETSENCRYPT=y JFFS_NVRAM=y NVRAM_ENCRYPT=y IPSEC=STRONGSWAN VISUALIZATION=n \
...
export DSL-AX82U += BUILD_NAME="DSL-AX82U" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y \
		IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y \
		ACCEL_PPTPD=y PRINTER=y WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n \
		BCMWL6=y BCMWL6A=y DISK_MONITOR=y BTN_WIFITOG=n OPTIMIZE_XBOX=y ODMPID=y LED_BTN=n BCMSMP=y XHCI=y \
		DUALWAN=y NEW_USER_LOW_RSSI=y OPENVPN=y TIMEMACHINE=y MDNS=y VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y \
		NOTIFICATION_CENTER=y BWDPI=y DUMP_OOPS_MSG=n LINUX_MTD="64" DEBUGFS=y TEMPROOTFS=n SSH=y EMAIL=y \
		FRS_FEEDBACK=n SYSSTATE=y ROG=n STAINFO=y CLOUDCHECK=y NATNL_AICLOUD=y REBOOT_SCHEDULE=y MULTICASTIPTV=n \
		QUAGGA=y WLCLMLOAD=n BCM_MUMIMO=y LAN50="all" ATCOVER=y GETREALIP=y CFEZ=y TFAT=y NTFS="tuxera" \
		HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y LAN4WAN_LED=n NEW_APP_ARM=y VISUALIZATION=n BONDING=n \
		BONDING_WAN=n NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=n ALEXA=y IFTTT=y SW_HW_AUTH=y HD_SPINDOWN=y \
		ASPMD=n BCM_MEVENT=n BCMEVENTD=y BCM_APPEVENTD=n LETSENCRYPT=y VPN_FUSION=n JFFS_NVRAM=y NVRAM_ENCRYPT=y \
		IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV NATNL_AIHOME=y BCM_CEVENTD=y UTF8_SSID=y AMAS=y DWB=y DBLOG=y \
		ETHOBD=y CFGSYNC_LOCSYNC=y CONNDIAG=y CRASHLOG=y WATCH_REINIT=n BW160M=y BRCM_HOSTAPD=y TCPLUGIN=n \
		UUPLUGIN=n IPERF3=y FRS_LIVE_UPDATE=y ASUSCTRL=y BCN_RPT=y BTM_11V=y INFO_EXAP=y AVBLCHAN=y \
		SW_CTRL_ALLLED=y OPEN_NAT=y ASD=y AHS=y INTERNETCTRL=y GAME_MODE=y PC_SCHED_V3=y INSTANT_GUARD=y
export DSL-AX82U += DISABLE_REPEATER_UI=y OOKLA=y WL_SCHED_V3=y TR069=y BCM_OAM=y MTWANCFG=y
export DSL-AX82U += TCPDUMP=y DSL=y VDSL=y DSL_BCM=y DSL_HOST=y MULTISERVICE_WAN=y
export DSL-AX82U += PWRRED_LED=y ETLAN_LED=y WANRED_LED=y BTN_WPS_ALLLED=y
export DSL-AX82U += NTPD=y DNSPRIVACY=y DNSFILTER=y
export DSL-AX82U += DISABLE_PROXYSTA_UI=y WIREGUARD=y SNMPD=y IPV6S46=y NFS=y

export RT-AX92U := $(HND-94908_BASE)
export RT-AX92U += BUILD_NAME="RT-AX92U" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
	   IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y \
	   ACCEL_PPTPD=y PRINTER=y WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n \
	   BCMWL6=y BCMWL6A=y  DISK_MONITOR=y BTN_WIFITOG=n OPTIMIZE_XBOX=y ODMPID=y LED_BTN=n BCMSMP=y XHCI=y  \
	   DUALWAN=y  NEW_USER_LOW_RSSI=y OPENVPN=y TIMEMACHINE=y MDNS=y VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y  \
	   BWDPI=y DUMP_OOPS_MSG=n LINUX_MTD="64" DEBUGFS=y TEMPROOTFS=n SSH=y EMAIL=y \
	   FRS_FEEDBACK=y SYSSTATE=y ROG=n STAINFO=y CLOUDCHECK=y NATNL_AICLOUD=y REBOOT_SCHEDULE=y MULTICASTIPTV=y  \
	   QUAGGA=y WLCLMLOAD=n BCM_MUMIMO=y LAN50="all" ATCOVER=y GETREALIP=y CFEZ=y ETLAN_LED=y TFAT=y NTFS="tuxera"  \
	   HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y NEW_APP_ARM=y VISUALIZATION=n BONDING=y  \
	   BONDING_WAN=y NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=y ALEXA=y IFTTT=y SW_HW_AUTH=y HD_SPINDOWN=y  \
	   ASPMD=n BCM_MEVENT=n BCMEVENTD=n BCM_APPEVENTD=n LETSENCRYPT=y VPN_FUSION=n JFFS_NVRAM=y NVRAM_ENCRYPT=y  \
	   IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV NATNL_AIHOME=y BCM_CEVENTD=y UTF8_SSID=y AMAS=y DBLOG=y  \
	   ETHOBD=y CONNDIAG=y NFCM=n DWB=y FRONTHAUL_DWB=y AMASDB=n CRASHLOG=y WATCH_REINIT=y BW160M=y BRCM_HOSTAPD=y \
	   UUPLUGIN=y IPERF3=y INFO_EXAP=y AMAZON_WSS=y AHS=y ASD=y FRS_LIVE_UPDATE=y ASUSCTRL=y OPEN_NAT=y  \
	   SW_CTRL_ALLLED=y GAME_MODE=y CFGSYNC_LOCSYNC=y INSTANT_GUARD=y  \
	   MSSID_PRELINK=y ACL96=y GOOGLE_ASST=y IPV6S46=y COMFW=y CALC_NVRAM=y
export RT-AX92U += DNSPRIVACY=y FORCE_AUTO_UPGRADE=n FRS_FEEDBACK=n
export RT-AX92U += IFTTT=y NTPD=y OPENSSL11=y NANO=y UPNPIGD2=n
export RT-AX92U += TOR=y SNMPD=n NFS=y WIREGUARD=y WIREGUARD=y

export RT-AX95Q := $(HND-947622_BASE)
export RT-AX95Q += BUILD_NAME="RT-AX95Q" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y \
		IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y \
		PRINTER=y WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y \
		DISK_MONITOR=y BTN_WIFITOG=n OPTIMIZE_XBOX=y ODMPID=y LED_BTN=n BCMSMP=y XHCI=y DUALWAN=y  NEW_USER_LOW_RSSI=y \
		OPENVPN=y TIMEMACHINE=y MDNS=y VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y BWDPI=y DUMP_OOPS_MSG=n LINUX_MTD="64" \
		DEBUGFS=y TEMPROOTFS=n SSH=y EMAIL=y FRS_FEEDBACK=y SYSSTATE=y ROG=n STAINFO=y CLOUDCHECK=y NATNL_AICLOUD=y \
		REBOOT_SCHEDULE=y MULTICASTIPTV=y QUAGGA=y WLCLMLOAD=n BCM_MUMIMO=y LAN50="all" ATCOVER=y GETREALIP=y CFEZ=y \
		ETLAN_LED=y TFAT=y NTFS="tuxera" HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y NEW_APP_ARM=y VISUALIZATION=n \
		BONDING=n BONDING_WAN=n NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=y ALEXA=y IFTTT=y SW_HW_AUTH=y HD_SPINDOWN=y \
		ASPMD=n BCM_MEVENT=n BCMEVENTD=n BCM_APPEVENTD=n LETSENCRYPT=y VPN_FUSION=n JFFS_NVRAM=y NVRAM_ENCRYPT=y \
		IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV NATNL_AIHOME=y BCM_CEVENTD=y UTF8_SSID=y AMAS=y DWB=y FRONTHAUL_DWB=y \
		DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y CONNDIAG=y NFCM=n CRASHLOG=y WATCH_REINIT=y BW160M=y BRCM_HOSTAPD=y UUPLUGIN=y \
		BT_CONN=y IPERF3=y MSSID_PRELINK=y FRS_LIVE_UPDATE=y BCM_CLED=y SINGLE_LED=y BCN_RPT=y BTM_11V=y INFO_EXAP=y \
		BCMEVENTD=y AMAS_ADTBW=y SW_CTRL_ALLLED=y AMAS_SYNC_2G_BW=y AMAZON_WSS=y AHS=y ASD=y INTERNETCTRL=y AVBLCHAN=y \
		ADTBW_RADAR=y INSTANT_GUARD=y AMAS_ETHDETECT=y RTL8221VB=y ACL96=y GOOGLE_ASST=y IPV6S46=y EXTEND_LIMIT=y ASUSCTRL=y \
		CALC_NVRAM=y OCNVC=y USB_WAN_BACKUP=y
export RT-AX95Q += TOR=y NTPD=y DNSPRIVACY=y DNSFILTER=y NTPD=y OPENSSL11=y NANO=y IFTTT=y FORCE_AUTO_UPGRADE=n FRS_FEEDBACK=n
export RT-AX95Q += UPNPIGD2=n VISUALIZATION=n WIREGUARD=y SNMPD=y NFS=y

export RT-AXE95Q := $(HND-947622_BASE)
export RT-AXE95Q += BUILD_NAME="RT-AXE95Q" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y \
		IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y \
		PRINTER=y WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y \
		DISK_MONITOR=y BTN_WIFITOG=n OPTIMIZE_XBOX=y ODMPID=y LED_BTN=n BCMSMP=y XHCI=y DUALWAN=y  NEW_USER_LOW_RSSI=y \
		OPENVPN=y TIMEMACHINE=y MDNS=y VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y BWDPI=y DUMP_OOPS_MSG=n LINUX_MTD="64" \
		...
		ETLAN_LED=y TFAT=y NTFS="tuxera" HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y NEW_APP_ARM=y VISUALIZATION=n \
		BONDING=n BONDING_WAN=n NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=y ALEXA=y IFTTT=y SW_HW_AUTH=y HD_SPINDOWN=y \
		ASPMD=n BCM_MEVENT=n BCMEVENTD=n BCM_APPEVENTD=n LETSENCRYPT=y VPN_FUSION=y JFFS_NVRAM=y NVRAM_ENCRYPT=y \
		IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV NATNL_AIHOME=y BCM_CEVENTD=y UTF8_SSID=y AMAS=y DWB=y \
		DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y CONNDIAG=y NFCM=n CRASHLOG=y WATCH_REINIT=y BW160M=y BRCM_HOSTAPD=y UUPLUGIN=n \
		BT_CONN=y IPERF3=y MSSID_PRELINK=y FRS_LIVE_UPDATE=y BCM_CLED=y SINGLE_LED=y BCN_RPT=y BTM_11V=y INFO_EXAP=y \
		BCMEVENTD=y AMAS_ADTBW=y SW_CTRL_ALLLED=y AMAS_SYNC_2G_BW=y AMAZON_WSS=n AHS=y ASD=y INTERNETCTRL=y AVBLCHAN=y \
		ADTBW_RADAR=y INSTANT_GUARD=y AMAS_ETHDETECT=y RTL8221VB=y HAS_5G_2=y WIFI6E=y FRONTHAUL_DWB=y ACL96=y GOOGLE_ASST=y EXTEND_LIMIT=y \
		WIREGUARD=y CALC_NVRAM=y COMFW=y
export RT-AXE95Q += TOR=y NTPD=y DNSPRIVACY=y DNSFILTER=y NTPD=y OPENSSL11=y NANO=y IFTTT=y FORCE_AUTO_UPGRADE=n FRS_FEEDBACK=n
export RT-AXE95Q += UPNPIGD2=n VISUALIZATION=n WIREGUARD=y SNMPD=y VPN_FUSION=n NFS=y

export RT-AX82U := $(HND-963178_BASE)
export RT-AX82U += BUILD_NAME="RT-AX82U" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=y WTFAST=n REPEATER=y IPV6SUPP=y \
		HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y \
		PRINTER=y WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y \
		DISK_MONITOR=y BTN_WIFITOG=n OPTIMIZE_XBOX=y ODMPID=y LED_BTN=y BCMSMP=y XHCI=y DUALWAN=y NEW_USER_LOW_RSSI=y \
		OPENVPN=y TIMEMACHINE=y MDNS=y VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y NOTIFICATION_CENTER=y BWDPI=y DUMP_OOPS_MSG=n \
		LINUX_MTD="64" DEBUGFS=y TEMPROOTFS=n SSH=y EMAIL=y FRS_FEEDBACK=n SYSSTATE=y ROG=n STAINFO=y CLOUDCHECK=y \
		NATNL_AICLOUD=y REBOOT_SCHEDULE=y MULTICASTIPTV=y QUAGGA=y WLCLMLOAD=n BCM_MUMIMO=y LAN50="all" ATCOVER=y \
		GETREALIP=y CFEZ=y TFAT=y NTFS="tuxera" HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y LAN4WAN_LED=n NEW_APP_ARM=y \
		VISUALIZATION=n BONDING=y BONDING_WAN=y NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=y ALEXA=y IFTTT=n SW_HW_AUTH=y \
		HD_SPINDOWN=y ASPMD=n BCM_MEVENT=n BCMEVENTD=y BCM_APPEVENTD=n LETSENCRYPT=y VPN_FUSION=n JFFS_NVRAM=y \
		NVRAM_ENCRYPT=y IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV NATNL_AIHOME=y BCM_CEVENTD=y UTF8_SSID=y AMAS=y DWB=y \
		DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y CONNDIAG=y CRASHLOG=y WATCH_REINIT=n BW160M=y BRCM_HOSTAPD=y TCPLUGIN=y \
		UUPLUGIN=y IPERF3=y FRS_LIVE_UPDATE=y ASUSCTRL=y BCN_RPT=y BTM_11V=y INFO_EXAP=y AVBLCHAN=y SW_CTRL_ALLLED=y \
		OPEN_NAT=y ASD=y AHS=y INTERNETCTRL=y GAME_MODE=y INSTANT_GUARD=y ACL96=y IPV6S46=y GOOGLE_ASST=y CALC_NVRAM=y
export RT-AX82U += DNSPRIVACY=y FORCE_AUTO_UPGRADE=n
export RT-AX82U += IFTTT=y NTPD=y OPENSSL11=y NANO=y UPNPIGD2=n
export RT-AX82U += TOR=y SNMPD=y NFS=y WIREGUARD=y

export RT-AX82_XD6 := $(HND-963178_BASE)
export RT-AX82_XD6 += BUILD_NAME="RT-AX82_XD6" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y IPV6SUPP=y \
        HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=n MODEM=n PARENTAL2=y ACCEL_PPTPD=y \
        PRINTER=n WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="none" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y \
        DISK_MONITOR=n BTN_WIFITOG=n OPTIMIZE_XBOX=y ODMPID=y LED_BTN=n BCMSMP=y XHCI=y DUALWAN=y NEW_USER_LOW_RSSI=y \
        OPENVPN=y TIMEMACHINE=n MDNS=n VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y BWDPI=y DUMP_OOPS_MSG=n \
        LINUX_MTD="64" DEBUGFS=y TEMPROOTFS=n SSH=y EMAIL=y FRS_FEEDBACK=y SYSSTATE=y ROG=n STAINFO=y CLOUDCHECK=n \
        NATNL_AICLOUD=n REBOOT_SCHEDULE=y MULTICASTIPTV=y QUAGGA=y WLCLMLOAD=n BCM_MUMIMO=y LAN50="all" ATCOVER=y \
        GETREALIP=y CFEZ=y ETLAN_LED=n TFAT=n NTFS="" HFS="" NO_SAMBA=y NO_FTP=y NO_USBSTORAGE=y NEWSSID_REV2=y NEWSSID_REV4=y NEW_APP_ARM=y \
        VISUALIZATION=n BONDING=n BONDING_WAN=n NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=y ALEXA=y IFTTT=n SW_HW_AUTH=y \
        HD_SPINDOWN=n ASPMD=n BCM_MEVENT=n BCM_APPEVENTD=n LETSENCRYPT=y VPN_FUSION=y JFFS_NVRAM=y \
        NVRAM_ENCRYPT=y IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV NATNL_AIHOME=y BCM_CEVENTD=y UTF8_SSID=y AMAS=y DWB=y \
        DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y CONNDIAG=y CRASHLOG=y WATCH_REINIT=n BW160M=y BRCM_HOSTAPD=y TCPLUGIN=n \
        UUPLUGIN=y BT_CONN=y IPERF3=y FRS_LIVE_UPDATE=y BCM_CLED=y SINGLE_LED=y BCN_RPT=y BTM_11V=y INFO_EXAP=y BCMEVENTD=y AVBLCHAN=y AMAS_SYNC_2G_BW=y SW_CTRL_ALLLED=y \
        CAPTCHA=y ASD=y AHS=y INTERNETCTRL=y GAME_MODE=n MSSID_PRELINK=y PC_SCHED_V3=y INSTANT_GUARD=y ACL96=y IPV6S46=y OCNVC=y GOOGLE_ASST=y ASUSCTRL=y WIREGUARD=y COMFW=y MSSID_REALMAC=y
export RT-AX82_XD6 += DNSPRIVACY=y FORCE_AUTO_UPGRADE=n
export RT-AX82_XD6 += IFTTT=y NTPD=y OPENSSL11=y NANO=y UPNPIGD2=n
export RT-AX82_XD6 += TOR=y SNMPD=y WIREGUARD=y VPN_FUSION=n
export RT-AX82_XD6 += MEDIASRV=y MODEM=y NO_USBSTORAGE=n

export HND-96750_BASE := HND_ROUTER=y HND_ROUTER_AX_6756=y PROFILE="96750GW" OOKLA=y WL_SCHED_V3=y SAMBA3="3.6.x" UBI=y UBIFS=y PSISTLOG=y
export RT-AX82U_V2 := $(HND-96750_BASE)
export RT-AX82U_V2 += BUILD_NAME="RT-AX82U_V2" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=n LACP=y DHD_6715B0=y WTFAST=n REPEATER=y \
        IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y USB_WAN_BACKUP=y PARENTAL2=y \
        ACCEL_PPTPD=y PRINTER=y WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y \
        BCMWL6A=y DISK_MONITOR=y BTN_WIFITOG=n OPTIMIZE_XBOX=y ODMPID=y LED_BTN=y BCMSMP=y XHCI=y DUALWAN=y \
        NEW_USER_LOW_RSSI=y OPENVPN=y TIMEMACHINE=y MDNS=y VPNC=y JFFS2LOG=y NOTIFICATION_CENTER=y BWDPI=y DUMP_OOPS_MSG=n \
        LINUX_MTD="64" DEBUGFS=y TEMPROOTFS=n SSH=y EMAIL=y FRS_FEEDBACK=y SYSSTATE=y ROG=n STAINFO=y CLOUDCHECK=y \
        NATNL_AICLOUD=y REBOOT_SCHEDULE=y MULTICASTIPTV=y QUAGGA=y WLCLMLOAD=n BCM_MUMIMO=y LAN50="all" ATCOVER=y GETREALIP=y \
        CFEZ=y TFAT=y NTFS="tuxera" HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y NEW_APP_ARM=y VISUALIZATION=n BONDING=y \
        BONDING_WAN=y NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=y ALEXA=y IFTTT=n SW_HW_AUTH=y HD_SPINDOWN=y ASPMD=n \
        BCM_MEVENT=n BCMEVENTD=y BCM_APPEVENTD=n LETSENCRYPT=y VPN_FUSION=y JFFS_NVRAM=y NVRAM_ENCRYPT=y IPSEC=STRONGSWAN \
        IPSEC_SRVCLI_ONLY=SRV NATNL_AIHOME=y BCM_CEVENTD=y UTF8_SSID=y AMAS=y DWB=y DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y \
        CONNDIAG=y CRASHLOG=y WATCH_REINIT=n BW160M=y BRCM_HOSTAPD=y TCPLUGIN=y UUPLUGIN=y IPERF3=y FRS_LIVE_UPDATE=y \
        ASUSCTRL=y BCN_RPT=y BTM_11V=y INFO_EXAP=y AVBLCHAN=y SW_CTRL_ALLLED=y OPEN_NAT=y ASD=y AHS=y INTERNETCTRL=y \
        GAME_MODE=y INSTANT_GUARD=y ACL96=y GOOGLE_ASST=y COMFW=y AMAS_ETHDETECT=y IPV6S46=y WIREGUARD=y
export RT-AX82U_V2 += DNSPRIVACY=y FORCE_AUTO_UPGRADE=n
export RT-AX82U_V2 += IFTTT=y NTPD=y OPENSSL11=y NANO=y UPNPIGD2=n
export RT-AX82U_V2 += TOR=y SNMPD=y NFS=y WIREGUARD=y VPN_FUSION=n

export RT-AX5400 := $(HND-96750_BASE)
export RT-AX5400 += BUILD_NAME="RT-AX5400" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=n LACP=y DHD_6715B0=y WTFAST=n REPEATER=y \
		IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y USB_WAN_BACKUP=y PARENTAL2=y \
		ACCEL_PPTPD=y PRINTER=y WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y \
		DISK_MONITOR=y BTN_WIFITOG=n OPTIMIZE_XBOX=y ODMPID=y LED_BTN=n BCMSMP=y XHCI=y DUALWAN=y NEW_USER_LOW_RSSI=y OPENVPN=y \
		TIMEMACHINE=y MDNS=y VPNC=y JFFS2LOG=y NOTIFICATION_CENTER=y BWDPI=y DUMP_OOPS_MSG=n LINUX_MTD="64" DEBUGFS=y TEMPROOTFS=n \
		SSH=y EMAIL=y FRS_FEEDBACK=y SYSSTATE=y ROG=n STAINFO=y CLOUDCHECK=y NATNL_AICLOUD=y REBOOT_SCHEDULE=y MULTICASTIPTV=y \
		QUAGGA=y WLCLMLOAD=n BCM_MUMIMO=y LAN50="all" ATCOVER=y GETREALIP=y CFEZ=y TFAT=y NTFS="tuxera" HFS="tuxera" NEWSSID_REV2=y \
		NEWSSID_REV4=y LAN4WAN_LED=y NEW_APP_ARM=y VISUALIZATION=n BONDING=y BONDING_WAN=y NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=y \
		ALEXA=y IFTTT=n SW_HW_AUTH=y HD_SPINDOWN=y ASPMD=n BCM_MEVENT=n BCMEVENTD=y BCM_APPEVENTD=n LETSENCRYPT=y VPN_FUSION=y \
		JFFS_NVRAM=y NVRAM_ENCRYPT=y IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV NATNL_AIHOME=y BCM_CEVENTD=y UTF8_SSID=y AMAS=y DWB=y \
		DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y CONNDIAG=y CRASHLOG=y WATCH_REINIT=n BW160M=y BRCM_HOSTAPD=y UUPLUGIN=n IPERF3=y \
		FRS_LIVE_UPDATE=y ASUSCTRL=y BCN_RPT=y BTM_11V=y INFO_EXAP=y AVBLCHAN=y SW_CTRL_ALLLED=y ASD=y AHS=y INTERNETCTRL=y \
		GAME_MODE=n INSTANT_GUARD=y ACL96=y GOOGLE_ASST=y COMFW=y WIREGUARD=y AMAS_ETHDETECT=y IPV6S46=y OCNVC=y GEARUPPLUGIN=y
export RT-AX5400 += TOR=y NTPD=y DNSPRIVACY=y DNSFILTER=y NTPD=y OPENSSL11=y NANO=y IFTTT=y FORCE_AUTO_UPGRADE=n FRS_FEEDBACK=n
export RT-AX5400 += UPNPIGD2=n VISUALIZATION=n WIREGUARD=y SNMPD=y VPN_FUSION=n NFS=y

export TUF-AX5400 := $(HND-963178_BASE)
export TUF-AX5400 += BUILD_NAME="TUF-AX5400" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=y WTFAST=n REPEATER=y IPV6SUPP=y \
		...
		BTN_WIFITOG=n OPTIMIZE_XBOX=y ODMPID=y LED_BTN=n BCMSMP=y XHCI=y DUALWAN=y NEW_USER_LOW_RSSI=y OPENVPN=y TIMEMACHINE=y \
		MDNS=y VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y NOTIFICATION_CENTER=y BWDPI=y DUMP_OOPS_MSG=n LINUX_MTD="64" DEBUGFS=y \
		TEMPROOTFS=n SSH=y EMAIL=y FRS_FEEDBACK=y SYSSTATE=y ROG=n TUF_UI=y OPEN_NAT=y STAINFO=y CLOUDCHECK=y NATNL_AICLOUD=y \
		REBOOT_SCHEDULE=y MULTICASTIPTV=y QUAGGA=y WLCLMLOAD=n BCM_MUMIMO=y LAN50="all" ATCOVER=y GETREALIP=y CFEZ=y TFAT=y \
		NTFS="tuxera" HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y LAN4WAN_LED=y NEW_APP_ARM=y BONDING=y \
		BONDING_WAN=y NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=y ALEXA=y IFTTT=y SW_HW_AUTH=y HD_SPINDOWN=y ASPMD=n \
		BCM_MEVENT=n BCMEVENTD=y BCM_APPEVENTD=n LETSENCRYPT=y VPN_FUSION=n JFFS_NVRAM=y NVRAM_ENCRYPT=y IPSEC=STRONGSWAN \
		IPSEC_SRVCLI_ONLY=SRV NATNL_AIHOME=y BCM_CEVENTD=y UTF8_SSID=y AMAS=y DWB=y DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y \
		CONNDIAG=y CRASHLOG=y WATCH_REINIT=n BW160M=y BRCM_HOSTAPD=y UUPLUGIN=y IPERF3=y FRS_LIVE_UPDATE=n ASUSCTRL=y \
		BCN_RPT=y BTM_11V=y INFO_EXAP=y AVBLCHAN=y SW_CTRL_ALLLED=y ASD=y AHS=y INTERNETCTRL=y GAME_MODE=y INSTANT_GUARD=y \
		ACL96=y IPV6S46=y GOOGLE_ASST=y COMFW=y CALC_NVRAM=y
export TUF-AX5400 += TOR=y NTPD=y DNSPRIVACY=y DNSFILTER=y NTPD=y OPENSSL11=y NANO=y IFTTT=y FORCE_AUTO_UPGRADE=n FRS_FEEDBACK=n
export TUF-AX5400 += UPNPIGD2=n VISUALIZATION=n WIREGUARD=y TUF_UI=n SNMPD=y NFS=y

export TUF-AX3000 := $(HND-963178_BASE)
export TUF-AX3000 += BUILD_NAME="TUF-AX3000" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=y WTFAST=n REPEATER=y IPV6SUPP=y \
                HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y \
                WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y DISK_MONITOR=y \
                BTN_WIFITOG=n OPTIMIZE_XBOX=y ODMPID=y LED_BTN=n BCMSMP=y XHCI=y DUALWAN=y NEW_USER_LOW_RSSI=y OPENVPN=y TIMEMACHINE=y \
                MDNS=y VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y NOTIFICATION_CENTER=y BWDPI=y DUMP_OOPS_MSG=n LINUX_MTD="64" DEBUGFS=y \
                TEMPROOTFS=n SSH=y EMAIL=y FRS_FEEDBACK=y SYSSTATE=y ROG=n TUF_UI=y OPEN_NAT=y STAINFO=y CLOUDCHECK=y NATNL_AICLOUD=y \
                REBOOT_SCHEDULE=y MULTICASTIPTV=y QUAGGA=y WLCLMLOAD=n BCM_MUMIMO=y LAN50="all" ATCOVER=y GETREALIP=y CFEZ=y TFAT=y \
				NTFS="tuxera" HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y LAN4WAN_LED=y NEW_APP_ARM=y VISUALIZATION=n BONDING=n \
                BONDING_WAN=n NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=y ALEXA=y IFTTT=y SW_HW_AUTH=y HD_SPINDOWN=y ASPMD=n \
                BCM_MEVENT=n BCMEVENTD=y BCM_APPEVENTD=n LETSENCRYPT=y VPN_FUSION=y JFFS_NVRAM=y NVRAM_ENCRYPT=y IPSEC=STRONGSWAN \
				IPSEC_SRVCLI_ONLY=SRV NATNL_AIHOME=y BCM_CEVENTD=y UTF8_SSID=y AMAS=y DWB=y DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y \
				CONNDIAG=y CRASHLOG=y WATCH_REINIT=n BW160M=y BRCM_HOSTAPD=y UUPLUGIN=y IPERF3=y FRS_LIVE_UPDATE=y ASUSCTRL=y \
				BCN_RPT=y BTM_11V=y INFO_EXAP=y AVBLCHAN=y SW_CTRL_ALLLED=y ASD=y AHS=y INTERNETCTRL=y GAME_MODE=y INSTANT_GUARD=y \
				ACL96=y IPV6S46=y GOOGLE_ASST=y WIREGUARD=y CALC_NVRAM=y COMFW=y
export TUF-AX3000 += TOR=y NTPD=y DNSPRIVACY=y DNSFILTER=y NTPD=y OPENSSL11=y NANO=y FORCE_AUTO_UPGRADE=n FRS_FEEDBACK=n
export TUF-AX3000 += UPNPIGD2=n VISUALIZATION=n IFTT=y LACP=n TUF_UI=n VPN_FUSION=n FRS_LIVE_UPDATE=n SNMPD=y NFS=y
...
export RT-AX68U += BUILD_NAME="RT-AX68U" NVSIZE="128" DHDAP=n HND_WL=y DPSTA=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
		...
		BTM_11V=y INFO_EXAP=y AVBLCHAN=y SW_CTRL_ALLLED=y INSTANT_GUARD=y PC_SCHED_V3=y VISUALIZATION=n \
...
export RT-AC68U_V4 += BUILD_NAME="RT-AC68U_V4" NVSIZE="128" DHDAP=n HND_WL=y DPSTA=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
                      ...
                      NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y NTPD=y DNSPRIVACY=y VISUALIZATION=n
...
export GT-AXE11000 += BUILD_NAME="GT-AXE11000" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=y REPEATER=y IPV6SUPP=y \
                      ...
                      VISUALIZATION=n NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=n ALEXA=y IFTTT=y SW_HW_AUTH=y HD_SPINDOWN=y \
                      ASPMD=n BCM_MEVENT=n BCMEVENTD=y BCM_APPEVENTD=n LETSENCRYPT=y VPN_FUSION=n JFFS_NVRAM=y NVRAM_ENCRYPT=y \
                      ...
                      GOOGLE_ASST=y EXTEND_LIMIT=y WIREGUARD=y HND_ROUTER_AX_6710=y CABLEDIAG=y COMFW=y USB_WAN_BACKUP=y \
...
export GT-AX6000 += BUILD_NAME="GT-AX6000" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y \
		...
		ETLAN_LED=y TFAT=y NTFS="tuxera" HFS="tuxera" NEWSSID_REV4=y NEW_APP_ARM=y VISUALIZATION=n \
		...
		WIREGUARD=y COMFW=y USB_WAN_BACKUP=y IG_SITE2SITE=n MAX_VPNF=4 WTFAST_V2=y \
...
export XT12 += BUILD_NAME="XT12" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y \
		...
		MSSID_PRELINK=y EXTEND_LIMIT=y GOOGLE_ASST=y VPN_FUSION=n AMAS_ADTBW=y BONDING=y BONDING_WAN=y VISUALIZATION=n \
		WIREGUARD=y CABLEDIAG=y UUPLUGIN=y DNSQUERY_INTERCEPT=n NFCM=n IG_SITE2SITE=n ROUTERBOOST=y \
...
export GT-AXE16000 += BUILD_NAME="GT-AXE16000" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y HTTPS=y \
		...
		VISUALIZATION=n WIREGUARD=y DNSQUERY_INTERCEPT=n NFCM=n USB_WAN_BACKUP=y IG_SITE2SITE=n \
		NFS=y SNMPD=y TOR=y UPNPIGD2=y NANO=y NTPD=y DNSPRIVACY=y IPSET=y
...
export GT-AX11000_PRO += BUILD_NAME="GT-AX11000_PRO" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y \
		...
		VISUALIZATION=n WIREGUARD=y USB_WAN_BACKUP=y MAX_VPNF=4 WTFAST_V2=y \
		NFS=y SNMPD=y TOR=y UPNPIGD2=y NANO=y NTPD=y DNSPRIVACY=y IPSET=y
...
export RT-AX86U_PRO += BUILD_NAME="RT-AX86U_PRO" NVSIZE="128" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y \
		...
		ATCOVER=y GETREALIP=y CFEZ=y TFAT=y NTFS="tuxera" HFS="tuxera" NEWSSID_REV4=y NEW_APP_ARM=y VISUALIZATION=n NETOOL=y \
		...
		I2CTOOLS=n AMAS=y DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y CONNDIAG=y IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV GEARUPPLUGIN=y \
...
export RT-AX88U_PRO += BUILD_NAME="RT-AX88U_PRO" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
		...
		VISUALIZATION=n COMFW=y BTN_WPS_ALLLED=y WIREGUARD=y REVERTFW=y INTEL_EVO=y IG_SITE2SITE=n WTFAST_V2=y \
		NFS=y SNMPD=y TOR=y UPNPIGD2=y NANO=y NTPD=y DNSPRIVACY=y IPSET=y

export HND-96756_BASE := HND_ROUTER=y HND_ROUTER_AX_6756=y PROFILE="96756GW" OOKLA=y WL_SCHED_V3=y SAMBA3="3.6.x" UBI=y UBIFS=y PSISTLOG=y CABLEDIAG=y
export TUF-AX3000_V2 := $(HND-96756_BASE)
export TUF-AX3000_V2 += BUILD_NAME="TUF-AX3000_V2" EXT_PHY="BCM84880" SWITCH2="BCM53134" NVSIZE="128" DHDAP=n HND_WL=y DPSTA=n \
		LACP=y WTFAST=n REPEATER=y IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y \
		USB_WAN_BACKUP=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="network" PROXYSTA=y DNSMQ=y \
		SHP=n BCMWL6=y BCMWL6A=y DISK_MONITOR=y BTN_WIFITOG=n OPTIMIZE_XBOX=y ODMPID=y LED_BTN=n BCMSMP=y XHCI=y DUALWAN=y \
		NEW_USER_LOW_RSSI=y OPENVPN=y TIMEMACHINE=y MDNS=y VPNC=y JFFS2LOG=y NOTIFICATION_CENTER=y BWDPI=y DUMP_OOPS_MSG=n \
		LINUX_MTD="64" DEBUGFS=y TEMPROOTFS=n SSH=y EMAIL=y FRS_FEEDBACK=y SYSSTATE=y ROG=n STAINFO=y CLOUDCHECK=y NATNL_AICLOUD=y \
		REBOOT_SCHEDULE=y MULTICASTIPTV=y QUAGGA=y WLCLMLOAD=n BCM_MUMIMO=y LAN50="all" ATCOVER=y GETREALIP=y CFEZ=y TFAT=y NTFS="tuxera" \
		HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y NEW_APP_ARM=y VISUALIZATION=n BONDING=y BONDING_WAN=n NETOOL=y TRACEROUTE=y \
		FORCE_AUTO_UPGRADE=y ALEXA=y IFTTT=y SW_HW_AUTH=y HD_SPINDOWN=y ASPMD=n BCM_MEVENT=n BCMEVENTD=y BCM_APPEVENTD=n LETSENCRYPT=y \
		VPN_FUSION=y JFFS_NVRAM=y NVRAM_ENCRYPT=y IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV NATNL_AIHOME=y BCM_CEVENTD=y UTF8_SSID=y \
		AMAS=y DWB=y DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y CONNDIAG=y CRASHLOG=y WATCH_REINIT=n BW160M=y BRCM_HOSTAPD=y UUPLUGIN=y \
		IPERF3=y FRS_LIVE_UPDATE=y ASUSCTRL=y BCN_RPT=y BTM_11V=y INFO_EXAP=y AVBLCHAN=y SW_CTRL_ALLLED=y ASD=y AHS=y INTERNETCTRL=y \
		TUF_UI=y OPEN_NAT=y GAME_MODE=y INSTANT_GUARD=y ACL96=y GOOGLE_ASST=y COMFW=y AMAS_ETHDETECT=y IPV6S46=y OCNVC=y WIREGUARD=y
export TUF-AX3000_V2 += TOR=y NTPD=y DNSPRIVACY=y DNSFILTER=y NTPD=y OPENSSL11=y NANO=y FORCE_AUTO_UPGRADE=n FRS_FEEDBACK=n
export TUF-AX3000_V2 += UPNPIGD2=n VISUALIZATION=n IFTT=y LACP=n TUF_UI=n VPN_FUSION=n FRS_LIVE_UPDATE=n SNMPD=y NFS=y
...
export RT-AX58U_V2 += BUILD_NAME="RT-AX58U_V2" NVSIZE="128" DHDAP=n HND_WL=y DPSTA=n LACP=n WTFAST=n REPEATER=y IPV6SUPP=y HTTPS=y \
		...
		GOOGLE_ASST=y COMFW=y WIREGUARD=y AMAS_ETHDETECT=y IPV6S46=y OCNVC=y GEARUPPLUGIN=y
export RT-AX58U_V2 += TOR=y NTPD=y DNSPRIVACY=y DNSFILTER=y NTPD=y OPENSSL11=y NANO=y FORCE_AUTO_UPGRADE=n FRS_FEEDBACK=n
export RT-AX58U_V2 += UPNPIGD2=n VISUALIZATION=n IFTT=y LACP=n TUF_UI=n VPN_FUSION=n FRS_LIVE_UPDATE=n SNMPD=y NFS=y
